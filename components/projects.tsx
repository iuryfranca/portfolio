					...
					<div className="flex flex-col">
						<div className="flex flex-col gap-2">
							...
							<p className="text-muted-foreground text-xs md:text-sm font-normal mb-8">
								Nesse projeto eu estava reaprendendo desenvolvimento web depois
								de 1 ano longe da área. Coloquei todo o meu foco em tecnologias
								mais populares da época e fiz esse pequeno e simples projeto
					...
					<div className="flex flex-col">
						<div className="flex flex-col gap-2">
							...
							<p className="text-muted-foreground text-xs md:text-sm font-normal">
								...
								objetivo era para usa aplicação onde o clinete pudesse escolher
								o produto, adicionar ao carrinho e finalizar a compra.
							</p>
							<p className="text-muted-foreground text-xs md:text-sm font-normal mb-8">
